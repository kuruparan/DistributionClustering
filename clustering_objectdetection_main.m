...
thres=0.07; % second order distance for acceptance to a clusterr
min_clus=2; % minimum number of images for creation of a clutser
max_dis=2; % ignore higher variance classes for speed, maximum is 2

outputMainFolder='clusters_signle5_withoutbreak-kdtre';
...
%[final_sol,clus_dist]=clustering_release_for_many_objectDetection8_run2(D, thres, min_clus, max_dis); 
