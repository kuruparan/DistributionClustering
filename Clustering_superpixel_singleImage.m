...
thres=0.35; % second order distance for acceptance to a cluster
min_clus=2; % minimum number of images for creation of a clutser
max_dis=4.1; % ignore higher variance classes for speed, maximum is 2
