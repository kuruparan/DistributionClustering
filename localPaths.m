function paths= localPaths()
    ...
    paths.libMatConvNet= '../Code/matconvnet-1.0-beta18/'; % should contain matlab/
    ...
    paths.dsetRootHolidays= '../Data/netvlad/Databases/InriaHolidays/'; % should contain jpg/ for the original holidays, or jpg_rotated/ for rotated Holidays, and be writable
    paths.dsetRootTokyoTM = '../Data/netvlad/Databases/tinyTimeMachine/';
    % --- our networks
